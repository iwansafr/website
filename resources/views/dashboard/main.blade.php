...
=======
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="logo">
                            <a href="/admin" style="font-size: 18px;">
                                {{-- <img src="/dist/assets/images/logo/logo.svg" alt="Logo"
                                    srcset=""> --}}
                                <i class="bi bi-browser-safari"></i> {{ env('APP_NAME') }}
                            </a>
                        </div>
...
<<<<<<< HEAD
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">{{ __('Main') }}
=======
